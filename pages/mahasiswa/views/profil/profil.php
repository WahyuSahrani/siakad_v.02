              ...
              <div class="box-body">
                <div class="row">
                  ...
                  <div class="form-group">
                    ...
                    <input readonly="on" type="text" class="form-control" name="nim" id="nim" placeholder="NIM" value="<?= $mahasiswa["nim"]; ?>">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="date" class="form-control" autocomplete="off" name="tanggal"  value="<?= $mahasiswa["tgl_lahir"]; ?>" placeholder="Tanggal Lahir" required>
                  </div>
                  <div class="form-group">
                   ...
                   <div class="form-group">
                    ...
                    <input type="number" class="form-control" autocomplete="off" name="telp" id="telp" value="<?= $mahasiswa["telp"]; ?>" placeholder="Telepon" required>
                  </div>
                </div>
