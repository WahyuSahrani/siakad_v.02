        ...
        <div class="col-xs-12">
            ...
            <div class="form-group">
              <?php 
                $semester = mysqli_query($conn, "SELECT DISTINCT semester.id_semester, nama_semester FROM semester
                            ...
                            WHERE khs.nim = $nim");
               ?>
               <select class="form-control select2" name="prodi"  id="prodi" style="width: 100%;" >
          ...
          <div class="row" id="nim"> 
            ...
            <!-- /.box-body --> 
             ...
             <a href="views/khs/cetak.php" target="_blank" class="btn btn-success btn-ms"><span class="glyphicon glyphicon-print"></span> Cetak </a>
