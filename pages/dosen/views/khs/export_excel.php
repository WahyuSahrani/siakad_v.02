...
$excel->setActiveSheetIndex(0)->setCellValue('B3', "ID KHS"); // Set kolom B3 dengan tulisan "NIS"
...
$excel->setActiveSheetIndex(0)->setCellValue('E3', "NILAI TUGAS"); // Set kolom D3 dengan tulisan "JENIS KELAMIN"
$excel->setActiveSheetIndex(0)->setCellValue('F3', "NILAI UTS"); // Set kolom E3 dengan tulisan "TELEPON"
$excel->setActiveSheetIndex(0)->setCellValue('G3', "NILAI UAS"); // Set kolom F3 dengan tulisan "ALAMAT"
$excel->setActiveSheetIndex(0)->setCellValue('H3', "NILAI AKHIR"); // Set kolom F3 dengan tulisan "ALAMAT"
$excel->setActiveSheetIndex(0)->setCellValue('I3', "NILAI HURUF"); // Set kolom F3 dengan tulisan "ALAMAT"
