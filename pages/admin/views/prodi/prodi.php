                ...
                <tr>
                	<td style="text-align: center;"><?= $i; ?></td>
              		...
              		<td style="text-align: center;">
               		 ...
               		 <a href="?page=prodi&aksi=hapus&id_jurusan=<?= $row["id_jurusan"]; ?>"onclick="return confirm('Anda Yakin Ingin Menghapus Data Ini?');" class="btn btn-danger btn-xs"><i class="glyphicon glyphicon-trash"></i> Hapus</a>
              		</td>              
                </tr>
                 <?php $i++; ?>
          		   <?php endforeach; ?>
