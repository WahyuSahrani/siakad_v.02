  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="?page=krs"><i class="fa fa-file-pdf-o"></i> <span> Kartu Rencana Studi</span></a></li>
        <li><a href="?page=khs"><i class="fa fa-file"></i> <span> Kartu Hasil Studi</span></a></li>
        <li><a href="?page=transkrip"><i class="fa fa-file"></i> <span> Transkip Nilai</span></a></li>
        <li><a href="?page=materi"><i class="fa fa-book"></i> <span> Materi Kuliah</span></a></li>
