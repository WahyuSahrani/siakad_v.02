 ...
 <!-- SELECT2 EXAMPLE -->
     ...
     <div class="box-body">
      ...
      <form method="POST" action="" enctype="multipart/form-data">
              ...
              <a href="views/khs/cetak.php" target="_blank" class="btn btn-success btn-ms"> <span class="glyphicon glyphicon-print"></span> Cetak </a> <br><br>
